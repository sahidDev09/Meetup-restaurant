...
const orderStats = [
  { label: "Pending", value: "0", icon: Clock, color: "text-amber-500", bg: "bg-amber-50 dark:bg-amber-500/10" },
  { label: "Preparing", value: "0", icon: ChefHat, color: "text-rose-500", bg: "bg-rose-50 dark:bg-rose-500/10" },
  { label: "Prepared", value: "0", icon: Package, color: "text-blue-500", bg: "bg-blue-50 dark:bg-blue-500/10" },
  { label: "Out for Delivery", value: "2", icon: Truck, color: "text-sky-500", bg: "bg-sky-50 dark:bg-sky-500/10" },
  { label: "Delivered", value: "6", icon: CheckCircle2, color: "text-green-500", bg: "bg-green-50 dark:bg-green-500/10" },
];
